...
for f in scripts/lokal-test/00_auth_stub.sql \
         ...
         supabase/migrations/0008_strammare_flyt.sql \
         ...
         scripts/lokal-test/04_tilgang_test.sql \
         scripts/lokal-test/05_strammare_flyt_test.sql; do
...
psql -v ON_ERROR_STOP=1 -d normaer_test \
  ...
  -f supabase/migrations/0008_strammare_flyt.sql
...
psql -v ON_ERROR_STOP=1 -d normaer_test -f scripts/lokal-test/05_strammare_flyt_test.sql
```
